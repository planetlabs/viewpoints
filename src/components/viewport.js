...
// Description: A viewport is a canvas which draws the scatterplot.
// While graph.js handles some state such as the x and y axes,
// viewport is responsible for actually drawing the plots.
